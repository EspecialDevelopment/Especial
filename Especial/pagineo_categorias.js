    ...
    if (this.classList.contains('flecha-derecha') || this.classList.contains('flecha-izquierda')) {
        ...
        if (pagineo['familia'] === 0) {
            ...
            for (let i = bl1 + bl2 * (pagineo['familia'] - 1), l = i + bl2; i < l; i++) {
                ...
                // si es el Ãºltimo elemento de familias
        ...
        // no tengo ni IDEA de cÃ³mo optimizar esto, pero es mejor dejarlo asÃ­
        if (fetch.length === bl1) {
            if (pagineo['familia'] === 0) {
...
=======
    ...
    /* ACTUALIZACIONES
     * CREAR LOS BOTONES DE PRODUCTOS SEGÃšN LA FAMILIA SELECCIONADA.
     * AL PRESIONAR BOTÃ“N CREAR CONSULTA UTIIZANDO XMLHttpRequest
     * ENVIANDO EL DATO A CONSULTAR A UNA SCRIPT PHP CON EL NOMBRE DE conProductos.php
     * ESTE SCRIPT RETONARÃ COMO EN EL EJEMPLO DE LAS FAMILIAS UN JSON CON LOS PRODUCTOS
     * CORRESPONDIENTES A LA FAMILIA SELECCIONADA INCLUYENDO EN CADA BOTÃ“N desc_prod
     * Y OCULTO precio_tarifa.
     */
